...
export function CartProvider({ children }) {
  ...
  const addToCart = async (productId, quantity = 1, selection = {} , customization = {}) => {
    const { data } = await api.post(`/cart/${cartId}/add`, { productId, quantity, selection, customization });
    setCart(data);
  };
